...
function generateManifest(version) {
    ...
    if (version === 2) {
        ...
        // Firefox-specific settings — data collection consent declaration
        // (required for new submissions; recommended for existing ones).
        // gecko.id is NOT set here because adding a fresh id to a manifest
        // whose AMO listing already has an auto-assigned id would make AMO
        // treat this upload as a different extension. Retrieve the
        // existing id from the AMO developer dashboard and add it as
        // "id": "<existing-amo-id>" inside the gecko block before the
        // warning becomes blocking.
